...
if(isset($_POST['update']))
{
	...
	print ' is updated';
		...
		$check_user2="select email from info WHERE part_id='$part_id'";
		...
		$check_user2="select tname from info WHERE part_id='$part_id'";
		$run=mysqli_query($link,$check_user2);
		$data2=mysqli_fetch_assoc($run);
		$code=$data2['tname'];		
		$part_id1=$code;
		...
		$check_user2="select place from info WHERE part_id='$part_id'";
		$run=mysqli_query($link,$check_user2);
		$data2=mysqli_fetch_assoc($run);
		$code=$data2['place'];		
		$part_id1=$code;
		...
		$msg="Congratulations team";
		mail("$msg2",'Congratulations...!!!',"$msg $msg3 on securing $msg4 place in Hackathon 1.0 conducted by Team Hackathon\n\n\n\n\nRegards,\nTeam Hackathon",'From: hackathon46jupiter@gmail.com');
