...
<div align="center"><br>
 <h1 align="center">RESET PASSWORD</h1>
   ...
   <input type="text" name="uname" placeholder="E-MAIL ID"><br /><br />
   
           
        
   <input type="submit" name="login" value="GET PASSWORD"><br><br></form>
...
if(isset($_POST['login']))
{
    ...
    $check_user="select * from coordinator WHERE user_name='$user_name'";
	$run=mysqli_query($link,$check_user);
if(mysqli_num_rows($run)>0){ 
        $check_user2="select user_pass from coordinator WHERE user_name='$user_name'";
		$run=mysqli_query($link,$check_user2);
		$data2=mysqli_fetch_assoc($run);
		$code=$data2['user_pass'];		
		$part_id=$code;
		$msg2=" $part_id ";
		$msg="USE THESE AS YOUR CREDENTIIALS FOR LOGIN:";
		mail("$user_name",'FORGOT PASSWORD..!!!DONT WORRY',"$msg\nUSER NAME : $user_name\nPASSWORD : $part_id",'From: hackathon46jupiter@gmail.com');
  ?><CENTER><b><?PHP  echo "PASSWORD HAS BEEN SENT TO REGISTERED E-MAIL..!!!";
}else
    {        
	?><b><?php	echo "Invalid E-mail..."; 
  print ' Please enter Registered E-mail...!!!';
    }
