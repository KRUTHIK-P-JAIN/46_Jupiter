        ...
        <div class="col-lg-12 col-md-12">
          <div class="mu-service-area">
            ...
            <div class="mu-service-single">
              <span><img src="img/first_prize.svg" alt="Los Angeles" style="width:100%;"></span>
              <h3>1st Prize Winner</h3>
              <p><h4>₹16,000 Cash
(For Both Societal Impact And Business Oriented Broad Areas)</h4></p>
            </div>
            <!-- Start single service -->
            <!-- Start single service -->
            <div class="mu-service-single">
              <span><img src="img/second_prize.svg" alt="Los Angeles" style="width:100%;"></span>
...
(For Both Societal Impact And Business Oriented Broad Areas)</h4></p>
            ...
            <!-- Start single service -->
            <div class="mu-service-single">
              <span><img src="img/ha.jpg" alt="Los Angeles" style="width:100%;"></span>
              <h3>Consolation Prize</h3>
              <p><h4>₹2,000 Cash
(For Each Consolation Prize)<br><br></h4></p>
            </div>
            <!-- Start single service -->
          </div>
        </div>
...
<body><br>
<div class="about">
<br><br><br><br><br><br><h2>BE READY TO EXPLORE YOURSELF TO REACH HIGH</h2>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        ...
        <p class="title"><B>UPCOMING EVENT</B></p>
      </div>
    </div>
  </div>
